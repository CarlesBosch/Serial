...
//********** VARIABLES ************************************************************
int drive_gb = 100;         // Variable que té el nom ( drive_gb ) i equival a 100
long drive_mb;              // Varaible que té el nom ( drive_mb )
...
void setup() {                          // S'executa un sol cop
  ...
  drive_mb = drive_gb;
  drive_mb = drive_mb * 1024;           // Multiplica 1024 amb els GB de capacitat
